       ...
       <View style={{flex:4}}></View>
        ...
        <View style={{display: "flex", flexDirection:"column", height:"100%", width:"100%"}}>
            <View style={{ displayL:"flex", flex:2, flexDirection:"row", width:"100%", height:"100%", justifyContent:"space-between"}}>
              <Text style={{ display:"flex", alignSelf:"flex-start", fontSize:32, fontFamily:"Plus Jakarta Sans", fontWeight:"bold", width:"50%", height:"100%", color:'#000000', marginVertical:"2%", marginHorizontal:"5%"}}>
             ...
             >
              <Text style={{ fontFamily:"Plus Jakarta Sans", display:"flex", alignSelf:"flex-end", fontSize:14, marginVertical:"7%", width:"50%", marginHorizontal:"20%",color:"grey", fontWeight:"800"  }}>SKIP</Text>
              </TouchableWithoutFeedback>
              </View>                
