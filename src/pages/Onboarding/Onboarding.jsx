       ...
       <View style={{flex:4}}>
        ...
        <View style={{display: "flex", flexDirection:"column", height:"100%", width:"100%"}}>
            <View style={{ flex:2, flexDirection:"row", width:"100%", height:"100%", alignSelf:"center", justifyContent:"center"}}>
              <Text style={{ display:"flex", alignSelf:"flex-start", fontSize:32, fontFamily:"Plus Jakarta Sans", fontWeight:"bold", width:"60%", height:"100%", color:'#000000', marginVertical:"2%",}}>Exclusive Tour Packages</Text>
             <TouchableOpacity
               activeOpacity={0.9}
               onPress={() => navigation.navigate("Signin") }>
              <Text style={{fontFamily:"Plus Jakarta Sans", justifyContent:"center",textAlign:"center", textAlignVertical:"center", alignSelf:"flex-end", fontSize:14, marginVertical:"7%", width:"40%", marginHorizontal:"11%",color:"grey", fontWeight:"800", height:"100%" }}>SKIP</Text>
              </TouchableOpacity>
              </View>                
