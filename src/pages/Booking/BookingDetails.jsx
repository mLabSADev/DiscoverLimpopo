...
const BookingDetails = ({ navigation, route }) => {
  ...
  const handleStars = (star, isPressed) => {
      ...
      BookingService.sendBookingReview(
  ...
  const handleComment = (star, isPressed) => {
  ...
  useEffect(() => {
    // console.log(route.params.booking.accomodationId, route.params.booking.bookingId);
    BookingService.getBookingReview(route.params.booking.accomodationId, route.params.booking.bookingId, (review) => {
         console.log({review})
         setReview(review);
    })
  }, [])
        ...
        >
          ...
          <Box style={styles.modalView}>
            ...
            <TextArea placeholder='Write your review...' alignSelf="center" width="90%" marginHorizontal="5%" height={150}
              backgroundColor="lightgrey" borderColor={'lightgrey'} borderWidth={1} borderRadius={20} bg={'primary.600'}
            ...
            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() => { handleComment(stars, true) }}
