  ...
  return (
    <SafeAreaView style={{ backgroundColor: "#F4FAFF", }}>
        ...
        <Box style={{ marginVertical: "2%" }}>
          ...
          <Box
            style={{ width: "95%", height: 300, backgroundColor: "rgba(42, 42, 42, 0.95)", alignSelf: "center", borderRadius: 30, marginVertical: "11%" }}>
            {magazine?.length <= 0 ? <Box justifyContent={"center"} alignItems={"center"} alignSelf={"center"} marginTop={"1%"} height={150} width="90%" borderColor={"rgb(239, 172, 50)"} borderRadius={30} borderWidth={1}>
              <Text>
            ...
            <Text fontFamily="Plus Jakarta Sans" color="#FFFFFF" fontSize={24} fontWeight="bold" style={{ marginHorizontal: "5%", marginVertical: "11%" }}>Our magazines are curated for travelling in mind</Text>
            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() => { navigation.navigate('Magazine') }}
              style={{ alignSelf: "center", borderColor: "rgb(239, 172, 50)", borderWidth: 1, width: "90%", height: 50, justifyContent: "center", borderRadius: 30, marginVertical: "-8%" }}>
