...
import { Text, Image, Box, Card, Button, Center} from 'native-base';
...
<Box style={{ height:336, backgroundColor:"grey", borderBottomLeftRadius:30, borderBottomRightRadius:30, width:"100%"}}>
    <Image alt='background' source={require('../../assets/images/RestaurantDetailBckground.jpg')} resizeMode="cover" style={{width:"100%", height:"100%",  borderBottomLeftRadius:30, borderBottomRightRadius:30}}/>   
...
<Box>
    ...
    <Image alt='profile' source={{uri: require('../../assets/images/John-Doe.jpg')}} style={{width:38, height:38, alignSelf:"flex-end", borderRadius:38, marginHorizontal:"10%"}}/>
    </TouchableOpacity>        
</Box>
</Box>

<Box style={{width:"100%", marginHorizontal:"4%", marginVertical:"5%" }}>
    <Text fontFamily="Plus Jakarta Sans" fontSize={34} color="rgb(0,0,0)" fontWeight="bold">Grab & Go Rabb Meals</Text>
...
<Image alt='resto2' source={require('../../assets/images/RestoDetails1.jpg')} style={{width:"100%", height:438}}/>
<Box style={{width:"80%", alignSelf:"center", marginVertical:"2%"}}>
    <Image alt='resto' source={require('../../assets/images/RestoDetails1.jpg')} style={{width:49, height:49, borderRadius:10, borderColor: 'rgb(239, 172, 50)', borderWidth:1}}/>
</Box>
